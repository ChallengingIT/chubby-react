  ...
  return (
    <div className="container-box-father">
      <div className="container-box">
        <Box
          sx={{
            gridColumn: "1 / -1", // Modifica per estendere il titolo dalla colonna 1 all'ultima colonna
            gridRow: "1", // Rendi il titolo nella prima riga
            width: "100%",
            textAlign: "center",
            marginBottom: "10px",
          }}
          ...
          <div key={index}>
            ...
            <Box
              sx={{
                ...
                textAlign: "left",
                marginTop: "8px", // Aggiunto spazio tra i campi
              }}
            >
