...
//     { label: "Curriculim Vitae",              name: "cv",                       type: "fileUploadCV"                                                            },
//     { label: "Consultant File",               name: "cf",                       type: "fileUploadCF"                                                            },
// ];
...
//         const cv = values.cv;
//         console.log("VERIFICO SE CV: ", cv);
//         const cf = values.cf;
//         console.log("VERIFICO SE CF: ", cf);
...
// export default AggiungiStaffing2;