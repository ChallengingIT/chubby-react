...
//funzionante al 19 dicembre 2023 13:50
...
import styles from "../../styles/DettaglioAziende.module.css";
...
import AttivitaCard from "../card/AttivitaCard";
...
const DettaglioAziende = () => {
  ...
  const SimpleBox = ({ fields, initialValues, tableTitle }) => (
    <div>
  ...
  return (
    ...
    alignItems: "flex-start", 
          ...
          <div className="containerTable">
            ...
            <div className={`containerDettaglioAziende ${styles.gridContainer}`}>
            <div className={`flex-container ${styles.gridContent}`}>

            <div
              className="containerSimpleData"
              style={{
                display: "flex",
                flexDirection: "column",
                minWidth: "450px",
            ...
            >
        <div className="primariga" style={{ display: "flex", justifyContent: "flex-start", marginLeft: "40px" }}>
  <div>
    <SimpleBox fields={fieldsInformazioniAzienda} initialValues={initialValuesInformazioniAzienda} tableTitle="Informazioni Azienda" />
  </div>
</div>
            </div>
            <div
            ...
            >
            <div className="secondariga" style={{ display: "flex", justifyContent: "flex-start", marginLeft: "40px" }}>
  <div>
    <SimpleBox fields={fieldsComunicazioni} initialValues={initialValuesComunicazioni} tableTitle="Comunicazioni" />
  </div>
  </div>
  </div>
  <div
...
>
  <div className="secondariga" style={{ display: "flex", justifyContent: "flex-start", marginLeft: "40px" }}>
    <div>
      {/* Passa i dati a SimpleTable */}
      <SimpleTable columns={tableNeed} initialValues={initialValuesNeed} tableTitle="Need" />
    </div>
  </div>
</div>
