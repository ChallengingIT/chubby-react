...
const initialValues = {
    stato:                            intervisteData.stato?.id                                                  || "",
    nome:                             intervisteData.nome                                                       || "",
    cognome:                          intervisteData.cognome                                                    || "",
    dataNascita:                      intervisteData.dataNascita                                                || "",
    location:                         intervisteData.citta                                                      || "", 
    tipologia:                        intervisteData.tipologia?.id                                              || "",
    anniEsperienza:                   intervisteData.anniEsperienza                                             || "",
    dataIncontro:                     intervistaData?.dataColloquio                                             || "",
    recapiti:                         intervistaData?.recapiti                                                  || "",
    owner:                            intervistaData?.owner?.id                                                 || "",
    aderenzaPosizione:                intervistaData?.aderenza                                                  || "",
    coerenzaPercorso:                 intervistaData?.coerenza                                                  || "",
    motivazionePosizione:             intervistaData?.motivazione                                               || "",
    standing:                         intervistaData?.standing                                                  || "",
    energia:                          intervistaData?.energia                                                   || "",
    comunicazione:                    intervistaData?.comunicazione                                             || "",
    livelloInglese:                   intervistaData?.inglese                                                   || "",
    competenzeRuolo:                  intervistaData?.competenze                                                || "",
    valutazione:                      intervistaData?.valutazione                                               || "",
    oneWord:                          intervistaData?.descrizioneCandidatoUna                                   || "",
    loVorrestiNelTuoTeam:             intervistaData?.teamSiNo                                                  || "",
    descrizione:                      intervisteData.note                                                       || "",
    disponibilita:                    intervistaData?.disponibilita                                             || "",
    ralAttuale:                       intervistaData?.attuale                                                   || "",
    ralDesiderata:                    intervistaData?.desiderata                                                || "",
    propostaEconomica:                intervistaData?.proposta                                                  || "",
    followUp:                         intervistaData?.tipo?.id                                                  || "",
    preavviso:                        intervistaData?.preavviso                                                 || "",
    nextDeadline:                     intervistaData?.nextDeadline                                              || "",
    ownerNextDeadline:                intervistaData?.nextOwner?.id                                             || ""
};
