  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const responseTipologia                      = await axios.get("https://localhost:8443/aziende/react/tipologia");
        const ownerResponse                          = await axios.get("https://localhost:8443/aziende/react/owner");
        const responseStato                          = await axios.get("https://localhost:8443/staffing/react/stato/candidato");
        const responseTipoIntervista                 = await axios.get("https://localhost:8443/intervista/react/tipointervista");
