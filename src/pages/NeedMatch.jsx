...
const NeedMatch = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            const candidatiResponse = await axios.get(
                `http://80.211.138.142:8443/need/react/match/associabili/mod/${id}`,
                { headers: headers, params: filtriCandidati }
            );
            const storicoResponse = await axios.get(
                `http://80.211.138.142:8443/need/react/storico/${id}`,
            ...
            const statoResponse = await axios.get(
                "http://80.211.138.142:8443/associazioni/react/stati",
                { headers: headers }
            );
    ...
    const fetchMoreDataCandidati = async (paginaCandidati) => {
        ...
        const url = filtriAttivi
            ? `http://80.211.138.142:8443/need/react/match/associabili/ricerca/mod/${id}`
            : `http://80.211.138.142:8443/need/react/match/associabili/mod/${id}`;
    ...
    const handleAssocia = async (row) => {
        try {
            ...
            const url = `http://80.211.138.142:8443/associazioni/react/associa?idNeed=${idNeed}&idCandidato=${idCandidato}`;
    ...
    const handleSaveModal = async (selectedRow) => {
        try {
            ...
            const response = await axios.post(
                `http://80.211.138.142:8443/associazioni/salva`,
                updateValues,
                { headers: headers }
            );
            fetchData();
    ...
    const handleModalIntervista = async (idCandidato) => {
        try {
            const responseIntervista = await axios.get(`http://80.211.138.142:8443/intervista/ultima/${idCandidato}`, {
                headers: headers
            });
