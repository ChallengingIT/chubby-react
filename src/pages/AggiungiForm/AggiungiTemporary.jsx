...
import { Box, Typography, Button, List, ListItem, ListItemIcon, ListItemText, Alert, Grid, Snackbar, Slide, Dialog, DialogTitle, IconButton, DialogContent, Autocomplete, DialogActions, Skeleton, TextField, Container, FormControl} from '@mui/material';
...
const AggiungiTemporary = () => {
    ...
    const handleNextButtonClick = () => {
      ...
      //funzione per il salvataggio
            ...
            if (!hasErrors) {
                try {
                    ...
                    if (response.data === "ERRORE") {
                        setAlert({ open: true, message: "errore durante il salvataggio del servizio temporary!" });
        ...
        //campi per aggiungi/modifica Temporary
        //maxLength messi completamente a sentimento
        //fammi sapere se vanno bene e quali sono i campi obbligatori
        const fields =[
            ...
            { label: "Durata attività",                 name: "durata",                   type: "text", maxLength: 45                             },


            { type: 'titleGroups',                label: "Economics"     },
            { label: "Canone mensile",                  name: "canoneMensile",            type: "decimalNumber", maxLength: 45                    },
            { label: "Importo da fatturare",            name: "importo",                  type: "decimalNumber", maxLength: 45                    },
...
export default AggiungiTemporary;