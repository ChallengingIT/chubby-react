    ...
    useEffect(() => {
        const fetchAziendeOptions = async () => {
            try {
                ...
                // const responseJobTitle            = await axios.get(`http://80.211.138.142:8443/aziende/react/tipologia/${id}`   , { headers: headers });
    ...
    const handleSubmit = async (values) => {
        ...
        if (!hasErrors) {
            try {
                ...
                const datiResponse = await axios.post("http://80.211.138.142:8443/staffing/salva", values, {
                    params: { skill: skills },
                    headers: headers,
                });
