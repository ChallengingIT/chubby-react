...
import ApiService from '../services/ApiService.js';
    ...
    const fetchData = async () => {
        ...
        const responseCandidato = await ApiService.request("getCandidato", {candidatoID: candidatoID}); //questo è il candidato
        ...
        const responseCandidatoFiltrato = await ApiService.request(
                "ricercaRecruiting",
                {},
                {},
                {},
    ...
    const handleDelete = async (id) => {
        try {
            ...
            const response = await ApiService.request("deleteIntervista", {deleteId: deleteId});
