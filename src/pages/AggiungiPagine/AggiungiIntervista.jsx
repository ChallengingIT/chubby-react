...
const fetchData = async () => {
    ...
    const responseIntervista                     = await axios.get(`https://89.46.67.198:8443/intervista/react/${candidatoID}`          , { headers: headers });
    const responseCandidato                      = await axios.get(`https://89.46.67.198:8443/staffing/react/${candidatoID}`            , { headers: headers }); 
