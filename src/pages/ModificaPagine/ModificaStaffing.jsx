  ...
  useEffect(() => {
    const fetchAziendeOptions = async () => {
      try {
        ...
        const responseFornitore           = await axios.get("http://89.46.67.198/fornitori/react", { headers: headers });
        ...
        const responseNeedSkill           = await axios.get("http://89.46.67.198/staffing/react/skill", { headers: headers });
