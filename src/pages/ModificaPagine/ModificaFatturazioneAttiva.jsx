...
const AggiungiFatturazioneAttiva = () => {
  ...
  useEffect(() => {
    const fetchAziendeOptions = async () => {
      try {
        ...
        const responseStato     = await axios.get("https://89.46.67.198:8443/fatturazione/attiva/react/stato", { headers: headers });
  ...
  const handleSubmit = async (initialValues) => {
    ...
    try {
      ...
      const response = await axios.post("https://89.46.67.198:8443/fatturazione/attiva/react/salva", initialValues, {
        headers: headers
      });
