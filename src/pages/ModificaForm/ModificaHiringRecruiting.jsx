...
const ModificaHiringRecruiting = () => {
            ...
            if (!hasErrors) {
                try {
                    ...
                    if (response.data === "ERRORE") {
                        setAlert({ open: true, message: "errore durante il salvataggio del servizio head hunting!" });
...
export default ModificaHiringRecruiting;