...
const ModificaRecruitingGrafica = () => {
    ...
    const fields = [
        ...
        { label: "Skill Area", name: "idSkillsAreas", type: "select", options: skillsAreasOptions },
    ...
    const initialValues = {
        ...
        idSkillsAreas: (datiModifica.idSkillsAreas && datiModifica.idSkillsAreas?.id) || null,
        idSkills: datiModifica.idSkills ? datiModifica.idSkills.map((skills) => skills.id) : [],
