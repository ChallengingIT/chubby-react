...
//solo quando il componente viene montato effettua la chiamata per prendere i dati del mese e dell'anno corrente
    useEffect(() => {
        ...
        axios.get(`http://89.46.67.198/timesheet/react/user/${anno}/${mese}`, {
            headers: headers,
    ...
    useEffect(() => {
        const fetchPrimoTimesheet = async () => {
            try {
                const response = await axios.get(`http://89.46.67.198/timesheet/react/user/primo`, {
                    headers: headers,
                    params: requestParams
                });
...
//chiamata per passare al mese o anno precedente
    const handlePrevMese = () => {
        ...
        axios.get(`http://89.46.67.198/timesheet/react/user/precedente/${annoNumero}/${meseNumero}`, {
            headers: headers,
            params: requestParams
        })
            .then(response => {
...
//chiamata per passare al mese o all'anno successivo
    const handleSuccMese = () => {
        ...
        axios.get(`http://89.46.67.198/timesheet/react/user/successivo/${annoNumero}/${meseNumero}`, {
            headers: headers,
            params: requestParams
        })
            .then(response => {
    ...
    useEffect(() => {
        ...
        const handleSubmitModal = async () => {
            ...
            try {
            const response = await axios.post(`http://89.46.67.198/timesheet/react/user/aggiorna/${annoNumero}/${meseNumero}`, datiDaInviare, {
                headers: headers,
                params: requestParams
            });
            if (response.data === "OK") {
        ...
        const fetchTimesheetData = async () => {
            try {
                const response = await axios.get(`http://89.46.67.198/timesheet/react/user/${annoNumero}/${meseNumero}`, {
                    headers: headers,
                    params: requestParams
                });
                const timesheetConId = response.data.mese.days.map((timesheet) => ({...timesheet}));
        ...
        const handleResetModalFPM = async () => {
            ...
            try {
                const response = await axios.post(`http://89.46.67.198/timesheet/react/user/cancella/${annoNumero}/${meseNumero}`, datiDaInviare, {
                    headers: headers,
                    params: requestParams
                });
                setModalOpen(false); 
        ...
        const handleSubmit = async () => {
            try {
                const url = `http://89.46.67.198/timesheet/react/user/salva/${annoNumero}/${meseNumero}`;
