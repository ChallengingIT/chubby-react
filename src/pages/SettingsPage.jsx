...
const handleSubmitChangePassword = async () => {
    ...
    try {
        ...
        const response = await ApiService.request("resetPassword", payload);
...
return (
    ...
    >
        ...
        <List sx={{ display: "flex", flexDirection: "column", width: "100%" }}>
            ...
            sx={{
                mb: 4,
                cursor: index !== null ? "pointer" : "not-allowed",
                "&.Mui-selected, &:hover": {
                    backgroundColor: theme.palette.aggiungiSidebar.hover,
                    "& .MuiListItemIcon-root, & .MuiListItemText-primary": {
                        color: theme.palette.aggiungiSidebar.textHover,
                    },
                    borderRadius: "10px",
                },
            }}
