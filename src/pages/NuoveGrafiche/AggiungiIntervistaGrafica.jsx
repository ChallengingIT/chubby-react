...
const AggiungiIntervistaGrafica = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            if (Array.isArray(responseCandidato.data)) {
                const candidato = responseCandidato.data.map((candidato) => ({
                label: candidato.descrizione,
                value: candidato.id,
                }));
        ...
        console.log("valori di candidato: ", interviste);



    const menu = [
        {
            title: 'Informazioni Canidato',
